/**
 * Admin - Instrument Requests Table Component
 * Displays instrument purchase requests with filtering, sorting, and view details
 */
...
export function AdminInstrumentRequestsTable() {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <Card>
                    <CardHeader className="pb-3">
                        ...
                        <CardTitle className="text-2xl md:text-3xl text-yellow-600 font-nums">{pending}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-3">
                        <CardDescription>Processing</CardDescription>
                        <CardTitle className="text-2xl md:text-3xl text-brand-blue font-nums">{processing}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-3">
