...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  try {
    ...
    if (!response.ok) {
      return {
        title: 'Instrument Not Found | Wealth Management CRM',
      };
    }
    ...
    return {
      title: `${instrument.name} (${instrument.symbol}) | Wealth Management CRM`,
    ...
    return {
      title: 'Instrument Details | Wealth Management CRM',
    };
  }
}
