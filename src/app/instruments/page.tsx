...
export const metadata: Metadata = {
  title: 'Browse Investment Instruments | Wealth Management CRM',
  description:
    'Explore our diverse range of investment instruments including stocks, bonds, mutual funds, ETFs, commodities, and real estate opportunities.',
  keywords: [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl md:text-4xl md:text-5xl font-bold mb-4">Investment Instruments</h1>
